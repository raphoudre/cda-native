        ...
        <View style={styles.container}>
            ...
            {drone.state ?
                <>
                    ...
                    <Text style={styles.textState}>État du drone : <Text style={drone.state == 'En Stock' ? styles.textStateDrone : styles.textStateDroneUnavailable && drone.state == 'En Location' ? styles.textStateDroneResa : styles.textStateDroneUnavailable}>{drone.state}</Text></Text>
